    ...
    return (
        <main className="Statistics bg-[#FFF6E0] z-40  mb-[-0.8rem] pt-8">
            <div>
                <div className=" flex justify-center items-center ">
                    ...
                    <div
                        className=" text-[2rem] lg:text-4xl "
                        style={{
                            fontWeight: "bold",
                            color: "#BF2E2E",
                            textShadow: `
        ...
        2px 3px 0 #131313`,
                ...
                <div className=" relative">
                    <div>
                        <Image
                            className=" absolute md:-top-[5%] -top-[33%] w-auto md:left-[3.5rem] left-[1rem] hidden md:flex"
                            src={up}
                            alt=""
                        />
                    </div>
                    <div>
                        <Image
                            className=" absolute md:top-[85%] top-[105%] w-auto md:right-[2.8rem] right-[1rem] hidden md:flex"
                            src={updown}
                            alt=""
                        />
                    </div>
