            ...
            >
                ...
                <div className="mx-auto md:flex hidden justify-center min-h-fit">
                    {NavData.map((item) => {
                        return (
                            ...
                            >
                                <Link
                                    className="md:px-7 hidden md:flex mt-4 font-bold md:text-sm font-oxanium hover:text-[#D03441]"
                                    href={item.path}
                                >
                                    {item.title}
                                </Link>
                ...
                <div className="w-screen md:hidden flex flex-col z-[300]">
                    <div className="flex justify-between md:hidden">
                        ...
                        >
                            {/* Close Button X */}
                            <svg
                                className={`transform transition-transform ease-in-out text-[#E16C00] duration-300 relative ${
                                    isMenuOpen ? "scale-0 w-0 h-0" : ""
                                }`}
                                style={{
                                    filter: "drop-shadow(0px 0.8px 0px #000)",
                                }}
                            ...
                            <svg
                                className={`transform transition-transform ease-in-out duration-300 text-[#E16C00] ${
                                    isMenuOpen ? "" : "scale-0 w-0 h-0"
                                }`}
                                style={{
                                    filter: "drop-shadow(0px 0.8px 0px #000)",
                ...
                <div className="hidden p-3 md:flex">
                    <button
                        ...
                        style={{
                            boxShadow:
                                "4px 4px 0px 0px rgba(0, 0, 0, 0.75); border: 3px solid rgba(0, 0, 0, 0.70)",
                        }}
                    >
                        Join Discord
                    </button>
