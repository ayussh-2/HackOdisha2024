        ...
        <>
            ...
            >
                <div className="sponsorandsitemap w-[100%] flex justify-between">
                    <div
                        className="becomeasponsor ml-[20px] md:ml-[50px] sm:ml-[35px] 2xl:ml-[115px] flex flex-col justify-start
        ...
        font-oxanium font-bold text-[13px] sm:text-[17px] md:text-[21px] 2xl:text-[28px] w-3/4 border-[3px]
         border-black border-solid shadow-[4px_4px_0_0_rgba(0,0,0,0.75)]"
                    ...
                    <div className="site mr-[19px] sm:mr-[26px] md:mr-[80px] 2xl:mr-[268px]">
                        <h1 className="font-archivoBlack font-normal text-[16px] sm:text-[25px] 2xl:text-[32px]">
                            Site map
                        </h1>
                        <ul className="mt-5">
                            {["About us", "FAQs"].map((item, index) => {
                                return (
                                    <li
                                        key={index}
                                        className="text-[12px] sm:text-[20px]  hover:scale-105 2xl:text-[25px] font-archivo font-semibold mb-2 flex items-center gap-3"
                                    >
                                        <a
                                            href={`#${item
                                                .toLowerCase()
